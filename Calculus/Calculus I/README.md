...
The main purpose of these notes is not for me to learn the contents of Calculus I. I am familiar with it all, either via school or by me learning the topics by myself. These notes are created with LaTeX, thus helping me learn how to use the software (very important). As a conseuqence, my notes for this are not likely to be completed, but all of the information is already condensed by Dawkin, whose exposition is rather good.
